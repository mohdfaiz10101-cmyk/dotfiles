...
**教训**: - [2026-05-31] [OP] 修复: Haven连接全部不可达 | 根因: (1)Haven MCP 绑定127.0.0.1:8730外网不可达 (2)数据库4个连接指向不可达端口(60002公网closed/127.0.0.1:7700外网不通) | 修复: (1)ADB forward
**教训**: - [2026-05-31] [OP] 修复: Haven连接全部不可达 (第2轮) | 根因: (1)nixos-codex-cli FRP映射60002→7700(ttyd)而非22(SSH)导致SSH连接握手失败 (2)19890/7700是HTTP服务配成SSH类型 (3)60002公网端口
