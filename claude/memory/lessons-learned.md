...
- [2026-06-01] [OP] 新建: ttyd-hermes | 端口: 7689 | 路由: /hermes/* | 功能: tmux hermes session终端 | 方式: 添加到Caddy launcher + systemd服务
- [2026-06-01] [OP] 修复: hermes端口分配 | 根因: 错误占用了17699(Caddy launcher) | 修复: FRP 19800→7689独立端口, 移除Caddy /hermes路由
