...
- [auto] 发现: docker.container.rss-freshrss-1 = 127.0.0.1:8420->80/tcp | 状态: Up 19 hours (healthy)

- [auto] 发现: docker.container.dfremote = 0.0.0.0:1235->1235/udp, [::]:1235->1235/udp | 状态: Up 22 hours

- [auto] 发现: docker.container.litellm-litellm =  | 状态: Up 23 hours (healthy)

- [auto] 发现: docker.container.twenty-worker-1 =  | 状态: Up 23 hours
...
- [auto] 发现: docker.container.rss-freshrss-1 = 127.0.0.1:8420->80/tcp | 状态: Up 20 hours (healthy)

- [auto] 发现: docker.container.dfremote = 0.0.0.0:1235->1235/udp, [::]:1235->1235/udp | 状态: Up 23 hours

- [auto] 发现: docker.container.litellm-litellm =  | 状态: Up 24 hours (healthy)

- [auto] 发现: docker.container.twenty-worker-1 =  | 状态: Up 24 hours
...
- [auto] 发现: docker.container.letta-chromadb = 0.0.0.0:8000->8000/tcp, [::]:8000->8000/tcp | 状态: Up 24 hours (healthy)

- [auto] 发现: docker.container.rss-freshrss-1 = 127.0.0.1:8420->80/tcp | 状态: Up 21 hours (healthy)

- [auto] 发现: docker.container.dfremote = 0.0.0.0:1235->1235/udp, [::]:1235->1235/udp | 状态: Up 24 hours

- [auto] 发现: docker.container.litellm-litellm =  | 状态: Up 25 hours (healthy)

- [auto] 发现: docker.container.twenty-worker-1 =  | 状态: Up 25 hours
...
- [auto] 发现: docker.container.letta-chromadb = 0.0.0.0:8000->8000/tcp, [::]:8000->8000/tcp | 状态: Up 25 hours (healthy)
